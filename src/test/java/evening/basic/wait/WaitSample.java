...
public class WaitSample {
    ...
    public void implicitWait(){
        ...
        driver.findElement(By.id("fdsfsfsd"));
    }
    ...
    public void scriptTimeout() {
        driver.manage().timeouts().setScriptTimeout(7, TimeUnit.SECONDS);
        ((JavascriptExecutor) driver).executeAsyncScript("alert('I am alert');");

    }

    public void explicitWait(){
        WebElement login = driver.findElement(By.xpath("/html/body/ngx-app/auth-base/nb-layout/div/div/div/div/div/nb-layout-column/nb-card/nb-card-body/div/div/login/form/button"));
        login.click();
